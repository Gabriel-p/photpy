...
C
C            OFFICIAL DAO VERSION:  1995 August 1
C
C***********************************************************************
C
C Current contents
...
C
      ...
      INTEGER LUN, ISTAT
C
c 1000 CALL GETNAM (PROMPT, FILE)
...
C is returned to the calling program equal to -1.1E30.
C
C=======================================================================
C
      IMPLICIT NONE
...
C
 ...
 8010    CALL GETDAT ('Lowest good data-value:', LOBAD, 1)
         IF (LOBAD .LE. -1.E30) GO TO 8010
 8020    CALL GETDAT ('Highest good data-value:', HIBAD, 1)
         IF (HIBAD .LE. -1.E30) GO TO 8020
      END IF
      NL=0
      RETURN
C
